            ...
            <div className="w-full hidden md:flex flex-col justify-center items-center mt-24">
                <div className="w-full flex flex-col justify-center items-center">
                    <div className="w-full flex justify-center items-center gap-5">
                        ...
                        <img className="w-9 h-9" src="https://www.boloforms.com/_next/static/media/2764.8838f014.svg" />
                    </div>
                    <p className="text-lg mt-4">Customers’ Testimonials</p>
                </div>
                <img className="w-full h-auto mt-10" src="https://www.boloforms.com/_next/static/media/timer_reviews.c0a05474.svg" />
            </div>
        </section>
    );
}
