    ...
    return (
        ...
        >
            <div className="w-full md:w-fit h-[75px] flex justify-between items-center px-4">
                <a href="/">
                    <img src="https://www.boloforms.com/_next/static/media/logo-text.e6f7617c.svg" className="w-32 h-auto" alt="BoloForms" />
                </a>
                <button
            ...
            {showMenu && (
                ...
                >
                    <div className="flex p-4 gap-4 mt-6 rounded-xl hover:bg-[#f3e8ff]">
                        <img className="w-6 h-6" src="https://www.boloforms.com/_next/static/media/TP.5489abce.svg" />
                    ...
                    <div className="flex p-4 gap-4 mt-3 rounded-xl hover:bg-[#f3e8ff]">
                        <img className="w-6 h-6" src="https://www.boloforms.com/_next/static/media/FA.c696cc9e.svg" />
                    ...
                    <div className="flex p-4 gap-4 mt-3 mb-6 rounded-xl hover:bg-[#f3e8ff]">
                        <img className="w-6 h-6" src="https://www.boloforms.com/_next/static/media/S.87bf14fd.svg" />
                        <div className="flex flex-col justify-center items-start">
