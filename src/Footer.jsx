...
import img1 from "./assests/footer_img_1.svg";
import img2 from "./assests/footer_img_2.svg";
import img3 from "./assests/footer_img_3.svg";
        ...
        <footer className="w-full flex flex-col justify-center items-center mt-24 px-8 md:px-[88px] pt-24 bg-secondary">
            <div className="w-full flex flex-col md:flex-row justify-center items-start">
                <div className="w-full flex flex-col justify-center items-start">
                    <a
                        href="https://api.whatsapp.com/send/?phone=918439345253&text=Need%20Help%20with%20BoloForms%20Approvals">
                        <h3 className="font-bold text-2xl mb-3">💬 Live Chat</h3>
                    </a>
                    <a href="mailto:support@boloforms.com">
                        <h3 className="font-bold text-2xl mb-3">📨 Support Email</h3>
                    </a>
                    <a href="https://approval-docs.boloforms.com/">
                        <h3 className="font-bold text-2xl mb-3">📚 Help Center</h3>
                    </a>
                    <a href="https://calendly.com/boloforms/15min">
            ...
            <div className="w-full flex flex-col md:flex-row justify-center md:justify-between items-start mt-12 ">
                <div className="flex text-sm mb-3">
                    Made with <img className="h-4 w-auto mx-4" src="https://www.boloforms.com/_next/static/media/1f525.a7bd71d6.svg" /> +
                    <img className="h-4 w-auto mx-4" src="https://www.boloforms.com/_next/static/media/2764.8838f014.svg" /> in India
                </div>
