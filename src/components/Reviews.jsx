        ...
        <>
            {type === 1 ? (
                <>
                    ...
                    >
                        ...
                        <div className="w-full flex flex-col justify-center items-start pl-4 md:pl-12">
                            <img className="h-6 w-auto rounded-full mb-4" src="https://www.boloforms.com/_next/static/media/Stars.885edd0c.svg" alt="" />
                ...
                <div className="w-full bg-[#9a6afd] flex flex-col justify-center items-center px-4 md:px-36 pt-16 mt-12">
                    ...
                    <img className="h-6 w-auto rounded-full mb-4 mt-6" src="https://www.boloforms.com/_next/static/media/Stars.885edd0c.svg" alt="" />
